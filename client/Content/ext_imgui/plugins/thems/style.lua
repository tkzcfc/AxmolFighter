...
function M.styleVarsDefault()
    ...
    style.WindowMenuButtonPosition = im.ImGuiDir.Left
    ...
    style.ColorButtonPosition = im.ImGuiDir.Right
...
function M.JetBrainsDarcula()
    ...
    set(col.TabSelected, ImVec4(78 / 255, 82 / 255, 84 / 255, 1))
    set(col.TabDimmed, ImVec4(51 / 255, 53 / 255, 55 / 255, 1))
    set(col.TabDimmedSelected, ImVec4(78 / 255, 82 / 255, 84 / 255, 1))
...
function M.AdobeDark()
    ...
    --set(col.TabSelected, ImVec4(0.195, 0.195, 0.195, 1.000))
    --set(col.TabDimmed, ImVec4(0.098, 0.098, 0.098, 1.000))
    --set(col.TabDimmedSelected, ImVec4(0.195, 0.195, 0.195, 1.000))
    ...
    set(col.TabSelected, ImVec4(050 / 255, 50 / 255, 50 / 255, 1))
    set(col.TabDimmed, ImVec4(38 / 255, 38 / 255, 38 / 255, 1))
    set(col.TabDimmedSelected, ImVec4(46 / 255, 46 / 255, 46 / 255, 1))
...
function M.CorporateGrey()
    ...
    set(col.TabSelected, ImVec4(0.33, 0.33, 0.33, 1.00))
    set(col.TabDimmed, ImVec4(0.25, 0.25, 0.25, 1.00))
    set(col.TabDimmedSelected, ImVec4(0.33, 0.33, 0.33, 1.00))
    set(col.DockingPreview, ImVec4(0.85, 0.85, 0.85, 0.28))

    if bit.band(im.getIO().ConfigFlags, im.ImGuiConfigFlags.ViewportsEnable) ~= 0 then
        style.WindowRounding = 0.0
...
function M.DarkTheme2()
    ...
    set(col.TabSelected, ImVec4(0.20, 0.25, 0.29, 1.00))
    set(col.TabDimmed, ImVec4(0.11, 0.15, 0.17, 1.00))
    set(col.TabDimmedSelected, ImVec4(0.11, 0.15, 0.17, 1.00))
    set(col.PlotLines, ImVec4(0.61, 0.61, 0.61, 1.00))
    set(col.PlotLinesHovered, ImVec4(1.00, 0.43, 0.35, 1.00))
    set(col.PlotHistogram, ImVec4(0.90, 0.70, 0.00, 1.00))
    set(col.PlotHistogramHovered, ImVec4(1.00, 0.60, 0.00, 1.00))
